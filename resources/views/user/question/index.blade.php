...
<div class="main-wrap">
  {!! Form::open(['route' => 'question.index', 'method' => 'GET']) !!}
    <div class="btn-wrapper">
      ...
      {!! Form::input('text', 'search_word', empty($inputs['search_word']) ? null : $inputs['search_word'], ['class' => 'form-control search-form', 'placeholder' => 'Search words...'] ) !!}
    ...
    <div class="category-wrap">
      ...
      @foreach ($categories as $category)
        <div class="btn" id="{{ $category->id }}">{{ $category->name }}</div>
      @endforeach
